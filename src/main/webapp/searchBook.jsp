...
<div class="row">
		...
		UserDAOImpl searchdao = new UserDAOImpl();
		List<AddBook> lists = searchdao.getBookBySearch(ch);
		for(AddBook b:lists)
		  {
		  %>
			<div class="col-md-3">
					...
					<div class="card-body text-center">
						...
						<div class="row">
							<a href="" class="btn btn-danger btn-sm ml-2"><i
								class="fa-solid fa-cart-shopping"></i>Buy</a> <a href="viewBookDetails.jsp?bid=<%=b.getBookId() %>"
